...
def product(product_code):
    opinions=pd.read(f"./app/data/opinions/{product_code}.json")
    return render_template('product.html', product_code=product_code, opinions=opinions.to_html(headers=True, classes='table table-striped table succes'))
